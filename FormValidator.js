export default class FormValidator {
    ...
    _checkInputValidity = (formElement, inputNames) => {
        if (!inputNames?.validity.valid) {
              this._showInputError(formElement, inputNames, inputNames.validationMessage);
        } else {
    ...
    _setEventListeners = (inputs,button) => {
        ...
        inputList.forEach((inputNames) => {
          ...
          inputNames.addEventListener("keydown", () => this._checkInputValidity(this._formElement, inputNames) );
